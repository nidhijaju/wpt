...
// empty document. Check the sandbox flags are properly inherited.
...
promise_test(async test => {
  ...
  // 2. From the sandboxed iframe, create an empty iframe, and open a popup. The
  // popup must inherit sandbox flags.
  ...
  assert_true(await popup_document.execute_script(isSandboxed),
    "popup is sandboxed'");
}, "test");
